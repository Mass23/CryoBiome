...
qiime feature-classifier extract-reads --i-sequences silva-138-99-seqs.qza --p-f-primer GTGCCAGCMGCCGCGGTAA --p-r-primer GGACTACHVGGGTWTCTAAT --p-min-length 200 --p-max-length 400 --o-reads silva-138-99_515f-806r_400-450_reads.qza
